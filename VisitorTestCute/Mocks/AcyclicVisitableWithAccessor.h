...
#ifndef SRC_ACYCLICVISITABLEWITHACCESSOR_H_
#define SRC_ACYCLICVISITABLEWITHACCESSOR_H_
...
class VisitableWithAccessor : public Repository::VisitableImpl<VisitableWithAccessor>{
public:
...
class VisitableWithAccessor2 : public Repository::VisitableImpl<VisitableWithAccessor2>{
public:
...
#endif /* SRC_ACYCLICVISITABLEWITHACCESSOR_H_ */
